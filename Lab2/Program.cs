class Program
{
    static void Main(string[] args)
    {
        ...
        while (!endApp)
        {
            ...
            Console.WriteLine("\tta - TriangleArea");
            Console.WriteLine("\tca - CircleArea");
            Console.WriteLine("\tmtbf - MTBF");
            Console.WriteLine("\tavailability - Availability");
            Console.WriteLine("\tfailureintensity - Current Failure Intensity");
            Console.WriteLine("\texpectedfailures - Average Number of Expected Failures");
            Console.WriteLine("\tdd - Defect Density");
            Console.WriteLine("\tssi - Shipped Source Instructions");
